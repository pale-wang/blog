...
BLOG_AUTHOR = "wangsheng"  # (translatable)
BLOG_TITLE = "WangSheng's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://wangsheng.life/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://wangsheng.life/"
BLOG_EMAIL = "hanadumal@outlook.com"
BLOG_DESCRIPTION = "This is WangSheng's tech blog."  # (translatable)
